...
def main():
    ...
    if input_text:
        ...
        domain_matches = [(match, 'Domain Name') for match in re.findall(domain_regex, input_text)]
        ...
        data = {'Type': [match[1] for match in email_matches + ip_matches + domain_matches + cve_matches + asn_matches],
                'Value': [match[0] for match in email_matches + ip_matches + domain_matches + cve_matches + asn_matches]}
